...
export class Login extends React.Component<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        if (!this.props.room_name) this.getNameSuggestion();

        this.roomChanged = (event) => this.setState({room_name: event.target.value});
        this.nameChanged = (event) =>
            this.setState({nickname: event.target.value, message: undefined});
                ...
                fetch(
                    ...
                    .then((res) => {
                        if (res.token) this.props.tokenAvailable(this.state.room_name, res.token);
                            ...
                            this.setState({message: "Dieser Name ist bereits vergeben."});
                    })
                ...
                <form onSubmit={this.handleSubmit}>
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <label htmlFor="room_name">Name des Raums:</label>
                                </td>
                                <td>
                                    <input
                                        id="room_name"
                            ...
                            <tr>
                                <td>
                                    <label htmlFor="nickname">Spielername:</label>
                                </td>
                                <td>
                                    <input
                                        id="nickname"
